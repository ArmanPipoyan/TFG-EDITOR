...
<div class="container">
    <div class="bg-secondary text-white">
        ...
        <form class="form mt-3 mb-4 ml-3 mr-3" action="/Controlador/newProblem.php" method="post" onsubmit="return validarProblema();" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                <input type="hidden" name="assignatura" value="<?php echo $_GET["assignatura"]?>" />
			</div>
...
<p class="alert alert-danger hide" id="error_mssg"><button type="button" class="close" data-dismiss="alert">&times;</button></p>
</div>
