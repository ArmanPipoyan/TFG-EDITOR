            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" action="/Controlador/newProblem.php"  method="post" onsubmit="return validarProblema();" enctype="multipart/form-data">

                            <fieldset>
                                <div class="form-card">
                                    <h2 class="fs-title">Detalls</h2> 
                                    <input type="text" name="title" id="titol" placeholder="Títol del problema" />
                                     <textarea type="text" name="descripcio" id="descripcio" placeholder="Descripció del problema" rows="3"></textarea>
