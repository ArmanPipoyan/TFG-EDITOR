...
<h3 class="text-center text-white pt-5">Formulari per crear problema</h3>
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" action="/Controller/problemNew.php" method="post"
                              onsubmit="return validateProblemAndFiles();" enctype="multipart/form-data">
                            <fieldset>
                                <div class="form-card">
                                    <h2 class="fs-title">Detalls</h2>
                                    <input type="text" name="title" id="title" placeholder="Títol del problema"/>
