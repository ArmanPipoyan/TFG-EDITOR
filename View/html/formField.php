        ...
        <?php } else { ?>
            ...
            <?php } else if($formField['type'] === "selector") { ?>
                <select id="<?php echo $formField['id'] ?>" class="input" name="<?php echo $formField['name'] ?>"
                    ...
                    <?php echo isset($formField['multiple'])? 'multiple='.$formField['multiple']: "" ?>
                    <?php echo isset($formField['value'])? 'value='.$formField['value']: "" ?>>
            ...
            <?php } else { ?>
                <input id="<?php echo $formField['id'] ?>" name="<?php echo $formField['id'] ?>"
                    ...
                    <?php echo isset($formField['maxlength'])? 'maxlength='.$formField['maxlength']: "" ?>
                    <?php echo isset($formField['minlength'])? 'minlength='.$formField['minlength']: "" ?>
                    <?php echo isset($formField['max'])? 'max='.$formField['max']: "" ?>
                    <?php echo isset($formField['min'])? 'min='.$formField['min']: "" ?>
                    <?php echo isset($formField['multiple'])? 'multiple': "" ?>
                    <?php echo isset($formField['value'])? 'value='.$formField['value']: "" ?>>
            <?php } ?>
            <div class="cut"></div>
